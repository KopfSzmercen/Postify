...
export type CommentFragmentFragment = { __typename?: 'PaginatedComment', id: number, text: string, updatedAt: string, creatorName: string, creatorId: number, canEdit: string };

export type NoteFragmentFragment = { __typename?: 'Note', createdAt: string, id: number, text: string, senderId?: number | null, type: string };

export type PostFragmentFragment = { __typename?: 'Post', id: number, createdAt: string, updatedAt: string, title: string, text: string, points: number, voteStatus?: number | null, commentsNumber: number, canEdit: string, paginatedComments?: Array<{ __typename?: 'PaginatedComment', id: number, text: string, updatedAt: string, creatorName: string, creatorId: number, canEdit: string }> | null, creator: { __typename?: 'User', id: number, username: string } };

export type UserFragmentFragment = { __typename?: 'UserProfile', username: string, id: number, friendshipStatus: string };
...
export type DeleteCommentMutation = { __typename?: 'Mutation', deleteComment: { __typename?: 'RegularResult', success: boolean, errors: Array<string> } };
...
export type GetMoreCommentsQuery = { __typename?: 'Query', getMoreComments: { __typename?: 'GetMoreCommentsResult', success: boolean, errors: Array<string>, hasMoreComments: boolean, paginatedComments?: Array<{ __typename?: 'PaginatedComment', id: number, text: string, updatedAt: string, creatorName: string, creatorId: number, canEdit: string }> | null } };

export type GetNotesQueryVariables = Exact<{ [key: string]: never; }>;


export type GetNotesQuery = { __typename?: 'Query', getNotes: { __typename?: 'GetNotesResult', success: boolean, errors?: Array<string> | null, notes: Array<{ __typename?: 'Note', createdAt: string, id: number, text: string, senderId?: number | null, type: string }> } };
...
export type GetUserByIdQuery = { __typename?: 'Query', getUserById: { __typename?: 'GetUserByIdResult', success: boolean, errors?: Array<string> | null, user?: { __typename?: 'UserProfile', username: string, id: number, friendshipStatus: string } | null } };
...
export type GetUsersQuery = { __typename?: 'Query', getUsers: { __typename?: 'GetUsersResult', success: boolean, hasMore: boolean, users: Array<{ __typename?: 'UserProfile', username: string, id: number, friendshipStatus: string }> } };
